...
from emil_to_addressee import emil_mail
...
cookies = {'tt_webid': '6899684706493662728'}  # 此处cookies可从浏览器中查找，为了避免被头条禁止爬虫
...
if __name__ == '__main__':
    ...
    user_list = [
                {'name':'self','add':'咸阳','email':'anoirz@outlook.com'},
                 ...
                 {'name':'self','add':'咸阳','email':'291630817@qq.com'},
                 {'name': 'dio', 'add': '上海', 'email': '1962268498@qq.com'},
                 {'name': '党悦晨', 'add': '西安', 'email': '1040658446@qq.com'},
                 {'name': '杨大基霸港', 'add': '咸阳', 'email': 'yxg100cycy@sina.cn'},
                 ]
    for i in user_list:
        main_(i)
        time.sleep(1)
